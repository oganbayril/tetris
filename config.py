...
# Used for wall kicks and rotation near blocks of tetrominos.
# Keys represent rotation states. For example, rotating from state 0 to state 1 will be from 0° to 90°
# Values represent the kick attempts which are tuples of (x, y). For example, (-1, +2) means move left by 1 cell and down by 2 cells. (because grid goes from top-left to bottom-right)
STANDARD_KICKS = {
